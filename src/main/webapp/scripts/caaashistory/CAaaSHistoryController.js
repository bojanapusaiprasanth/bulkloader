...
var CAaaSHistoryController = BaseController.extend({
    ...
    defineScope: function() {
        ...
        me.$scope.toggleFormulaInstanceStatus = me.toggleFormulaInstanceStatus.bind(this);
...
//        me._refreshtimer = me.$interval(me.getHistory.bind(me), 30000);
    ...
    toggleFormulaInstanceStatus: function(metadata, $event){
        $event.stopPropagation();
        var me = this;
        var instance = metadata;

        if(!this._cloudElementsUtils.isEmpty(instance.active)) {
            instance.active = !instance.active;
        }
        return me._history.updateFormulaInstance(instance);
    },
