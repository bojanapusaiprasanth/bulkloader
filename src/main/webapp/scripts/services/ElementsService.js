...
var ElementsService = Class.extend({
    ...
    updateFormulaInstance: function(instance) {

        var url = this._application.environment.elementsUrl + "/formulas/" + instance.formula.id + "/instances/"  + instance.id;
        return this._httpPut(url, this._getHeaders(), instance);
    },
    ...
    createFormulaInstance: function(formulaId, name, formulaName, configuration, settings) {
        var me = this;
