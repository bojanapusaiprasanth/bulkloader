...
var FormulaInstance = Class.extend({
    ...
    createFormulaInstance: function(formulaInstanceName, formulaName, formulaInstanceConfiguration, settings) {
        var me = this;
        return me._elementsService.createFormulaInstance(me.formulaTemplate.id, formulaInstanceName, formulaName, formulaInstanceConfiguration, settings).then(
