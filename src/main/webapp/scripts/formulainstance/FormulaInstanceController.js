...
var FormulaInstanceController = BaseController.extend({
    ...
    save: function() {
        ...
        if (me._formulaInstance.formulaTemplate.notificationEmail) {
            settings = {'notification.email': me._formulaInstance.formulaTemplate.notificationEmail}
        }

        if (me._formulaInstance.formulaTemplate.instanceName) {
            formulaInstanceName = me._formulaInstance.formulaTemplate.instanceName
        }


        me._formulaInstance.createFormulaInstance(formulaInstanceName, me.$scope.formulaName,me.$scope.formulaInstanceData, settings).
