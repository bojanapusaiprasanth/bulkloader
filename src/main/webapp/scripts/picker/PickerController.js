...
//        me.getBranding();
    ...
    defineScope: function() {
        ...
        me.$scope.onElementHover = me.onElementHover.bind(me);
...
//        }
    ...
    onElementHover: function($event) {
        ...
        setTimeout(function(){
            var hoveredElement = document.getElementById($event.target.id);
            if(hoveredElement) {
                hoveredElement.scrollIntoView({'behavior': "smooth"});
            }
            }, 50);
    },
